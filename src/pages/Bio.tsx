...
const age = moment('19890906', 'YYYYMMDD')
  .fromNow()
  .match(/[0-9]{1,2}/);
    ...
    <div className="mainPadding">
      <div id="socialMediaIconsContainer">
        ...
        <div id="linksInnerContainer">
          ...
          <a
            href="http://stackoverflow.com/users/1408603/martingo89"
            target="_blank"
          >
            <i className="fab fa-stack-overflow fa-3x"></i>
          </a>
          <a
            href="https://www.instagram.com/sonesson.mini.painting/"
            target="_blank"
          >
          ...
          <a
            href="https://cults3d.com/en/users/martinsonesson/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              version="1.1"
              viewBox="0.00 0.00 591.00 564.00"
      ...
      <div
        className="mainContentItem marginTopLarge"
        id="bioContent"
        style={{ width: '100%' }}
      >
        <div style={{ float: 'left', width: '100%', textAlign: 'center' }}>
              ...
              <span className="tableRowCell" id="informationCell">
                ...
                >
                  <div className="tableRow">
                    ...
                    <span className="tableRowCell">
                      <p className="rowValueSpan">{age}</p>
                    </span>
                  </div>
                  <div className="tableRow">
                    <span className="tableRowCell">
                  ...
                  <div className="tableRow">
                    ...
                    <span className="tableRowCell">
                      <p className="rowValueSpan">
                        IT-consultant,{' '}
                        <a href="https://www.twoday.se/" target="_blank">
                          twoday
                        </a>
                      </p>
                    </span>
          ...
          <div
            ...
            style={{ textAlign: 'center', padding: '20px 40px 20px 40px' }}
          >
            <p className="textBody">
              My name is Martin Sonesson and I'm a {age} year old software
              developer from Gothenburg. I have always been interested in
              computers, IT and software and I have been creating websites since
              the glorious days of Geocities and web 2.0. In 2009 I started
              studying software engineering at Chalmers University of
              Technology. Three years later, in 2012, I did my bachelors thesis
              at ESAB. The thesis consisted of developing a tool for analyzing
              data traffic between components in an industrial welding system.
              More information about my bachelors thesis can be found{' '}
              <a href="projects/exjobb">here</a>. After three exciting and fun
              years at Chalmers I started my first job as a programmer at
              Cochlear Ltd where I helped develop a windows application used for
              calibrating hearing devices. I worked at Cochlear for a year and
              during that time I developed and learned a lot. Shortly after that
              I began working at Knowit as a consultant.
              <br />
              <br />
              Via Knowit I have worked about four years on a constulancy
              assignment at{' '}
              <a href="https://www.telia.se/privat" target="_blank">
                Telia
              </a>
              where I began as a purely frontend developer but later
              transitioned into becoming more of a full stack developer. During
              these three years I have developed a lot as a person and as a
              programmer. I've had the privilege of working with a lot of
              skilled colleagues in a big organization that requires good
              communication and collaboration skills. Also, on the frontend side
              specifically, I got used to working with very modern web
              technologies in an everchanging tech stack that requires keeping
              up with the fast evolution of the web.
              <br />
              <br />
              After my time at Knowit I switched employer to{' '}
              <a href="https://www.annevo.se/" target="_blank">
                Annevo
              </a>{' '}
              (now known as twoday) where I continued working as a consultant.
              My first assignment was at{' '}
              <a href="https://www.wirelesscar.com/" target="_blank">
                WirelessCar
              </a>
              where I stayed for about 2 years. At WirelessCar I spent most of
              my time working specifically on frontend development building web
              applications based on Angular and VueJs. After my time at
              WirelessCar I did a shorter consultancy assignment at{' '}
              <a href="https://www.barium.se/" target="_blank">
                Barium
              </a>{' '}
              for about 6 months. My time there was cut short due to unexpected
              changes to the project I was working on. I then began a new
              assignment at{' '}
              <a href="https://www.recordedfuture.com/" target="_blank">
                Recorded Future
              </a>{' '}
              where I am still working. The project that I am focusing on is
              developing a{' '}
              <a
              ...
              that is built using modern native Javascript syntax.
              <br />
              <br />I enjoy working on my own projects on my spare time, whereas
              this very website is one of those. Under the{' '}
              <a href="/projects">projects section</a>
              you can view some of my additional work with detailed
              explanations. You may also checkout my{' '}
              <a href="http://www.github.com/sonesson89" target="_blank">
                Github profile
              </a>
              .
              <br />
              <br />
              I am a passionate and friendly person. I am keen to learn new
              things and enjoy new challenges. I consider myself a creative
              person who enjoy creating things from scratch and understanding
              how they work. Challenging tasks that require me to come up with
              my own solutions in order to overcome a specific problem
              stimulates me significantly. Lately I've been more and more into
              webdevelopment in particular due to my newest employment and
              within that field I strive to become a full-stack developer, since
              I very much enjoy being able to do everything from wireframes and
              design to backend logic and database handling.
              <br />
              <br />
              In my spare time I enjoy <a href="/art">drawing</a>, gaming,
              movies, travelling, running, powerlifting and martial arts. I like
              to keep myself busy and try out new things.
            </p>
          </div>
        </div>
      </div>
